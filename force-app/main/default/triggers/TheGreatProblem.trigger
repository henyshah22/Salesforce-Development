...
trigger TheGreatProblem on Contact (before insert, before update, after insert) {

    if (Trigger.isBefore) {
        TheGreatProblemHandler handler = new TheGreatProblemHandler(Trigger.new,Trigger.old,Trigger.newMap,Trigger.oldMap,Trigger.isInsert,Trigger.isUpdate,Trigger.isDelete,Trigger.isAfter,Trigger.isBefore);
        handler.handleBeforeInsertOrUpdate();
    }
}
